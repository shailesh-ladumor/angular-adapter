...
const _c0 = ["ref"];
function FlatfileButtonComponent_span_4_Template(rf, ctx) {
    if (rf & 1) {
...
function FlatfileButtonComponent_span_5_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementStart(0, "span");
...
FlatfileButtonComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: FlatfileButtonComponent, selectors: [["flatfile-button"]], viewQuery: function FlatfileButtonComponent_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, inputs: { token: "token", mountUrl: "mountUrl", apiUrl: "apiUrl" }, outputs: { onInit: "onInit", onUpload: "onUpload", onLaunch: "onLaunch", onClose: "onClose", onComplete: "onComplete", onError: "onError" }, ngContentSelectors: _c1, decls: 6, vars: 5, consts: [[3, "disabled", "click"], ["ref", ""], [4, "ngIf"]], template: function FlatfileButtonComponent_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵprojectionDef();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(FlatfileButtonComponent, [{
            type: Component,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(FlatfileAdapterModule, [{
            type: NgModule,
            args: [{
